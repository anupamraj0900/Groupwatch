...
<>
      ...
      <div className="flex gap-6 items-center">
          <button className="hover:text-white transition duration-300"> <IoEnterSharp size={25} /> </button>
            
            <p className ="text-white mt-5 text-xl font-medium mb-3"> Join party </p> 
